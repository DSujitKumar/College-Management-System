				...
				<div class="grid_12">
					...
					<div class="menu_block">
						<nav id="bt-menu" class="bt-menu">
							...
							<ul>
								<li class="current bt-icon"><a href="teacherBody.jsp">Home</a></li>								
								<li class="bt-icon"><a href="changeTeacherPassword.jsp">Change Password</a></li>
								<li class="bt-icon"><a href="gallery.jsp">gallery</a></li>
								<li class="bt-icon"><a href="registration.jsp">Registration</a></li>							
