...
<div class="mainbody">
	<div class="image">
	<img alt="admin" src="images/newimages/teacher.png">
	</div>
	<div class="loginform">
	<center>
	<%
	...
	%>
	<form action="cms.controller.TeacherLogin" method="post" id="lform">
		<table>
			...
			<tr><th style="padding-top: 2px; text-align: left; color: #3a709e;"><a href="teacherForgogtPassword.jsp">Forgot Password</a></th><th><input type="submit"  value="Login" id="btn"><input type="reset" value="Reset" id="btn" ></th></tr>
		</table>
	</form></center>
	</div>
</div>
