				...
				<div class="grid_12">
					...
					<div class="menu_block">
						<nav id="bt-menu" class="bt-menu">
							...
							<ul>
								<li class="current bt-icon"><a href="studentBody.jsp">Home</a></li>								
								<li class="bt-icon"><a href="changeStudentPassword.jsp">Change Password</a></li>
								<li class="bt-icon"><a href="gallery.jsp">gallery</a></li>
								<li class="bt-icon"><a href="registrationPage.jsp">Registration</a></li>							
								<li class="bt-icon"><a href="contact.jsp">Contact</a></li>
								<li class="bt-icon"><a href="cms.controller.Logout">Logout</a></li>
							</ul>
						</nav>
						<div class="clear"></div>
					</div>
