  				...
  				while(it.hasNext()){
  					...
  					%>
  						...
  						<td><%=tr.getGender() %></td>
  							...
  							<td><%=tr.getSpecialization() %></td>
  							<td><%=tr.getDepartment() %></td>
  							<td><%=tr.getJobtitle() %></td>
  							<td><%=tr.getSalary() %></td>
  							<td><%=tr.getJoindate() %></td>
  							...
  							<% 
  								...
  								{
  							%>
  									<td><img src="profileimg/g.jpg"></td>
  							<%
  								}
  								else
  								{
  							...
  							<td><a href="cms.controller.DeleteTeacher?regdno=<%=tr.getId()%>"><img src="images/deleteUser.jpg" height="20" width="50"></a></td>
  						</tr>
  					<%
  				}
  			%>
