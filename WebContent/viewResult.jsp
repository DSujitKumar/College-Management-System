...
width :80%;
border-radius :30px;
border-top: 60px solid #19a54e;
border-bottom: 60px solid #2e6f46;
border-left: 6px solid #19a54e;
border-right: 6px solid #19a54e;
...
<jsp:include page="studentHeader.jsp"></jsp:include>
	...
	%>
	<form action="cms.controller.ViewResult" method="post" id="lform" enctype="multipart/form-data">
